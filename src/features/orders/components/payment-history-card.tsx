  ...
  return (
    <div className="relative group w-full overflow-hidden">
      <div className="space-y-1 px-1.5 w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex gap-4" key={payment.payment_id}>
            ...
            <div className="flex-1 pb-3">
              <div className="bg-card border rounded-lg p-3">
                ...
                <AppButton
                  onClick={() =>
                    window.open(payment.payment_slip_url, "_blank")
                  }
                  Icon={Image}
                  size="sm"
                  fullWidth
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
          <div className="flex items-center gap-2 bg-primary/60 px-4 py-2 rounded-full">
            <AppIcon
              Icon={Mouse}
              size="sm"
              className="fill-primary-foreground"
            />
            <AppText size="text-xs" color="primaryForeground">
              Keep scroll
            </AppText>
          </div>
        </div>
